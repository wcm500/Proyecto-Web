                    ...
                    <div class="card rounded-0">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-6 d-flex stat my-3">
                                    <div class="mx-auto">
                                        <h6 class="text-muted">Cantidad de Pymes registradas</h6>
                                        <h3 class="font-weight-bold">0</h3>
                                ...
                                <div class="col-lg-3 col-md-6 d-flex my-3">
                                    <div class="mx-auto">
                                        <h6 class="text-muted">Clientes  en el sistema</h6>
                                        <h3 class="font-weight-bold">0</h3>
                  ...
                  <div class="container">
                      <div class="row">
                          ...
                          <div class="col-lg-4 my-3">
                            <div class="card rounded-0">
                                <div class="card-header bg-light">
                                    <h6 class="font-weight-bold mb-0">Pymes Registradas</h6>
                                </div>
                                <div class="card-body pt-2">
                                    <div class="d-flex border-bottom py-2">
                                        ...
                                        <div class="align-self-center">
                                          <h6 class="d-inline-block mb-0">Casa Linda</h6><span class="badge badge-success ml-2">Hogar</span>
                                          <small class="d-block text-muted">Nombre Empresario: Randall Martinez</small>
                                        </div>
                                    </div>
                                    <div class="d-flex border-bottom py-2">
                                        <div class="d-flex mr-3">
